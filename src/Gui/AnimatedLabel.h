...
namespace AV
{
    ...
    public:
        ...
        virtual void updateGlyphs( Colibri::States::States state, bool bPlaceGlyphs );

        virtual void _fillBuffersAndCommands( Colibri::UiVertex * colibrigui_nonnull * colibrigui_nonnull
