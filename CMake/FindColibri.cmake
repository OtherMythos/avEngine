...
FIND_LIBRARY(COLIBRI_ZLIB NAMES z zlib
    PATHS ${Colibri_ROOT}/lib64/
    PATH_SUFFIXES a
    )
...
if(COLIBRI_LIBRARY)
    set(Colibri_LIBRARY "${Colibri_LIBRARY};${COLIBRI_LIBRARY};${COLIBRI_FREETYPE};${COLIBRI_HARFBUZZ};${COLIBRI_ICU};${COLIBRI_ZLIB};${COLIBRI_SDSLIB}" CACHE STRING "" FORCE)
endif()
