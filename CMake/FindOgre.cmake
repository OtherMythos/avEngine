...
set(Ogre_LIBRARY "${Ogre_LIBRARY};${LIB_OGRE_MAIN};${LIB_HLMS_PBS};${LIB_HLMS_UNLIT}"
    CACHE STRING "" FORCE)
set(Ogre_INCLUDE_DIR "${Ogre_INCLUDE_DIR};${OGRE_MAIN_INCLUDE};${OGRE_HLMS_PBS_INCLUDE};${OGRE_HLMS_UNLIT_INCLUDE};${OGRE_HLMS_COMMON_INCLUDE};${OGRE_PLUGIN_PARTICLE_INCLUDE};${OGRE_PLUGIN_VULKAN_INCLUDE}"
    CACHE STRING "" FORCE)
