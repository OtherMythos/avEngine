...
namespace {
    ...
    protected:
        ...
        void TearDown() override{
            //Mirrors Base::shutdown's ordering: the manager drains its own jobs first, then the
            //shared pool goes down. Without this, the pool started by dispatching real jobs here
            //stays up for the rest of the binary and JobDispatcherTests' "nothing has started yet"
            //assertions fail depending on test order.
            manager->shutdown();
